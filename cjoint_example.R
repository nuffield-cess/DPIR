...
attribute_list[["Reason for Application"]] <- c("reunite with family","seek better job",
                                                "escape persecution")
...
marginal_weights[["Job"]] <- rep(1/length(attribute_list[["Job"]]),length(attribute_list[["Job"]]))
